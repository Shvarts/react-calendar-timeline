...
var ItemsCollection = function (_Component) {
    _inherits(ItemsCollection, _Component);

    function ItemsCollection() {
        _classCallCheck(this, ItemsCollection);

        return _possibleConstructorReturn(this, (ItemsCollection.__proto__ || Object.getPrototypeOf(ItemsCollection)).apply(this, arguments));
    }
    ...
    _createClass(ItemsCollection, [{
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                width = _props3.width,
                canvasWidth = _props3.canvasWidth;
            ...
            var cellRenderer = function cellRenderer(_ref) {
                ...
                return item && sortedDimensionItems[(0, _generic._get)(item, itemIdKey)] && _react2.default.createElement(_Item2.default, {
                    key: key,
                    style: style,
                    item: item,
            ...
            var cellSizeAndPositionGetter = function cellSizeAndPositionGetter(_ref2) {
                ...
                var datum = dimensionItems[index].dimensions;
