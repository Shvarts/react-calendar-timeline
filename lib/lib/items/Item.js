...
Item.defaultProps = {
  selected: false,
  itemRenderer: function itemRenderer(_ref) {
    var item = _ref.item,
    ...
    return _react2.default.createElement(
      ...
      itemContext.showInnerContentsRender && _react2.default.createElement(
        'div',
        {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getItemProps = function () {
    ...
    var classNames = 'rct-item' + (_this3.props.selected ? ' selected' : '') + (_this3.canMove(_this3.props) ? ' can-move' : '') + (_this3.canResizeLeft(_this3.props) || _this3.canResizeRight(_this3.props) ? ' can-resize' : '') + (_this3.canResizeLeft(_this3.props) ? ' can-resize-left' : '') + (_this3.canResizeRight(_this3.props) ? ' can-resize-right' : '') + (_this3.props.item.className ? ' ' + _this3.props.item.className : '');

    var dimensions = _this3.props.dimensions;
    ...
    return {
      ...
      onContextMenu: (0, _events.composeEvents)(_this3.handleContextMenu, props.composeEvents),
