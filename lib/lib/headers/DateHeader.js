...
var DateHeader = function (_React$PureComponent) {
  ...
  function DateHeader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateHeader.__proto__ || Object.getPrototypeOf(DateHeader)).call.apply(_ref, [this].concat(args))), _this), _this.getHeaderUnit = function () {
    ...
    }, _this.headerRenderer = function (_ref2) {
      ...
      var unit = _this.getHeaderUnit();

      return _react2.default.createElement(
        'div',
        _extends({
          className: _this.props.className
        }, getRootProps({ style: _this.getRootStyle() })),
        intervals.map(function (interval) {
          var intervalText = _this.getLabelFormat([interval.startTime, interval.endTime], unit, interval.labelWidth);
          return _react2.default.createElement(_Interval2.default, {
            ...
            secondaryHeader: !!_this.props.secondaryHeader,
  ...
  _createClass(DateHeader, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_CustomHeader2.default, { unit: unit, children: this.headerRenderer });
    }
  }, {
    key: 'getLabelFormat',
