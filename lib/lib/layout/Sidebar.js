...
var Sidebar = function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !((0, _generic.arraysEqual)(nextProps.groups, this.props.groups) && nextProps.keys === this.props.keys && nextProps.width === this.props.width && nextProps.groupHeights === this.props.groupHeights && nextProps.height === this.props.height && nextProps.headerHeight === this.props.headerHeight && nextProps.content === this.props.content);
    }
  }, {
    ...
    value: function render() {
      ...
      var headerClass = this.props.stickyHeader ? 'header-sticky' : '';
