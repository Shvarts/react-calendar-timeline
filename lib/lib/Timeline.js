...
var _ItemsCollection = require('./items/ItemsCollection');
...
// import {ScrollSync, ScrollSyncPane} from '../../node_modules/react-scroll-sync/src';

var list = [{ name: 'Brian Vaughn', x: 13, y: 34, width: 123, height: 234 }, { name: 'Brian Vaughn', x: 136, y: 34, width: 123, height: 234 }, { name: 'Brian Vaughn', x: 149, y: 34, width: 123, height: 234 }, { name: 'Brian Vaughn', x: 164, y: 34, width: 123, height: 234 }, { name: 'Brian Vaughn', x: 177, y: 34, width: 123, height: 234 }, { name: 'Brian Vaughn', x: 190, y: 34, width: 123, height: 234
  // And so on...
}];
...
var ReactCalendarTimeline = function (_Component) {
  ...
  function ReactCalendarTimeline(props) {
    ...
    _this.state = {
      ...
      resizingItem: null,
      resizingEdge: null,
      viewPortVisibleItems: _this.props.items
    };
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    // getViewPortVisibleItems = (canvasTimeStart, canvasTimeEnd) => {
    //   const { keys, groups, items } = this.props
    //   const groupOrders = getGroupOrders(groups, keys)
    //   const visibleItems = getVisibleItems(items, canvasTimeStart, canvasTimeEnd, keys)
    //   const sortedDimensionItems = keyBy(this.state.dimensionItems, 'id')

    //   const viewPortItems = visibleItems.filter(item => {
    //     const dimensions = item && sortedDimensionItems[_get(item, 'id')] && sortedDimensionItems[_get(item, 'id')].dimensions
    //     return dimensions && dimensions.top > window.scrollY && dimensions.top < window.scrollY + window.innerHeight; 
    //   });

    //   this.setState({ viewPortItems: viewPortItems })
    // }
    ...
    key: 'items',
    value: function items(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, dimensionItems, groupHeights, groupTops, width, height) {

      return _react2.default.createElement(_ItemsCollection2.default, {
        canvasTimeStart: canvasTimeStart,
        canvasTimeEnd: canvasTimeEnd,
        canvasWidth: canvasWidth,
        dimensionItems: dimensionItems,
        groupTops: groupTops,
        items: this.props.items //this.state.viewPortItems || 
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  this.items(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, dimensionItems, groupHeights, groupTops, width, height),
                  _react2.default.createElement(
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.resize = function () {
    ...
    var _headerRef$getBoundin = _this4.headerRef.getBoundingClientRect(),
        headerHeight = _headerRef$getBoundin.height;
  ...
  this.onScroll = function (scrollX) {
    ...
    // this.getViewPortVisibleItems(canvasTimeStart, canvasTimeEnd)
