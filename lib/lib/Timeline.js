  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function stackItems(items, groups, canvasTimeStart, visibleTimeStart, visibleTimeEnd, width) {
      ...
      var _props = this.props,
          ...
          itemHeightRatio = _props.itemHeightRatio;
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          timeSteps = _props2.timeSteps,
          traditionalZoom = _props2.traditionalZoom;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.resize = function () {
    ...
    var _headerElement$getBou = _this4.headerElement.getBoundingClientRect(),
        headerHeight = _headerElement$getBou.height;
  ...
  this.registerScrollListener = function (elm) {
    _this4.headerElement = elm;
  };
